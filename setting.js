/**
 * ISHAQ-MD v4.5.0 - Cloud Configuration Manager
...
const rawOwnerNumbers = getEnv('OWNER_NUMBER', '923134158840', 'string');
...
const config = {
    ...
    BOT_NAME: getEnv('BOT_NAME', 'ISHAQ-MD', 'string'),
    STICKER_NAME: getEnv('STICKER_NAME', 'ISHAQ-MD', 'string'),
    MODE: getEnv('MODE', 'public', 'string').toLowerCase(),
    
    // Owner Ecosystem
    OWNER_NUMBERS: OWNER_NUMBERS,
    OWNER_NAME: getEnv('OWNER_NAME', 'TECH ISHAQ', 'string'),
